...
LLM_EDITOR_DAILY_REQUEST_LIMIT = env_int("LLM_EDITOR_DAILY_REQUEST_LIMIT", 24)
LLM_EDITOR_DAILY_CHAR_LIMIT = env_int("LLM_EDITOR_DAILY_CHAR_LIMIT", 60000)
LLM_EDITOR_MAX_DIGEST_ITEMS = env_int("LLM_EDITOR_MAX_DIGEST_ITEMS", 10)
LLM_EDITOR_MAX_BREAKING_ITEMS = env_int("LLM_EDITOR_MAX_BREAKING_ITEMS", 8)
...
LLM_EDITOR_BREAKING_MIN_INTERVAL_SECONDS = env_int("LLM_EDITOR_BREAKING_MIN_INTERVAL_SECONDS", 1800)
