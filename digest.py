...
DIGEST_LLM_ABSOLUTE_DENY_TERMS = (
    ...
    "aviso jose felix diaz pone alerta madridismo",
    "aviso de jose felix diaz pone en alerta al madridismo",
    ...
    "fabrizio romano drops bombs",
    "fabrizio romano suelta bombas",
    "uefa sobre planes fifa",
    "uefa on fifa plans",
    "fifa deadline for federations",
    "ranking where real madrid teams stand among the best champions league winners since 2020",
    "tomas roncero si vinicius acepta cobrar",
    ...
    "delantero tapado pedia mourinho",
    "delantero tapado que pedia mourinho",
    "maxence lacroix",
    "jaime marcos",
    "jaime marcos psicologo",
    "caso video sexual",
    "jueza caso video sexual canteranos",
    "jueza del caso video sexual canteranos",
    ...
    "vinicius ultimatum",
    "real madrid vinicius ultimatum",
    "vinicius saca su lado paterno",
    "vinicius saca lado paterno",
    "looks happy with his stepson",
    "florentino perez has to sacrifice vinicius",
    "sacrifice vinicius jr",
    "learn from his real galactico mistake",
    "galactico mistake",
    "sinsentido camavinga",
    "el sinsentido de camavinga",
    "surprising camavinga case",
    "camavinga case",
    ...
    "otros rodris de jose mourinho",
    "otros rodris de josé mourinho",
    ...
    "trophyless since 2024",
    "isnt the real reason they have been trophyless",
    "isn't the real reason they have been trophyless",
    "transfer roundup: chelsea sell trevoh chalobah",
    "bring the noise",
    "fulham 2026 27 season preview",
    "fulham 2026/27 season preview",
    ...
    "equipaciones de primera y segunda division",
    ...
    "gracias @mariocortegana",
    "thanks @mariocortegana",
    "r to @mariocortegana",
